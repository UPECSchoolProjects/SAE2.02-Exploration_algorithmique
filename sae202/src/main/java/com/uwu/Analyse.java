...
public class Analyse {
    ...
    static private java.util.Map<String, String> exceptedMap = java.util.Map.ofEntries(
            java.util.Map.entry("é", "e"),
            java.util.Map.entry("è", "e"),
            java.util.Map.entry("ê", "e"),
            java.util.Map.entry("à", "a"),
            java.util.Map.entry("â", "a"),
            java.util.Map.entry("î", "i"),
            java.util.Map.entry("ï", "i"),
            java.util.Map.entry("ô", "o"),
            java.util.Map.entry("û", "u"),
            java.util.Map.entry("ù", "u"),
            java.util.Map.entry("ç", "c"),
            java.util.Map.entry("œ", "oe"),
            java.util.Map.entry("æ", "ae"),
            java.util.Map.entry("ë", "e"),
            java.util.Map.entry("ü", "u"),
            java.util.Map.entry("ÿ", "y"),
            java.util.Map.entry("Æ", "Ae"),
            java.util.Map.entry("Ø", "Oe"),
            java.util.Map.entry("Å", "Aa"),
            java.util.Map.entry("Þ", "Th"),
    ...
    //
    public void ecrireCSV(String nomFichier) throws IOException { // Génère un fichier CSV avec les mots et leur
                                                                  // fréquence
